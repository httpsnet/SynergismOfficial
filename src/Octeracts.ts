...
export class OcteractUpgrade extends DynamicUpgrade {
  ...
  public actualTotalLevels (): number {
    if ((player.singularityChallenges.noOcteracts.enabled || player.singularityChallenges.sadisticPrequel.enabled || player.singularityChallenges.extra20.enabled) && !this.qualityOfLife) {
      return 0
    }
