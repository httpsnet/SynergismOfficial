...
export const areward = (i: number): string => {
    ...
    const descs: {[key: number]: string} = {
        ...
        274: 'There is nothing here.',
        275: 'These do not work here due to the conflict between the official and Singularity Automation.',
        276: 'why? This is because I added Singularity Automation before the achievements here were officially born.',
        277: 'Survive well and brilliantly.',
        278: 'Well, there are no notes.',
        279: 'Yeah really. If anything happens, I will add it.',
        280: 'Currently, the balance changes depending on my play. It\'s still early to play.'
    }
